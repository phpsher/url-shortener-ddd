...
use App\Application\Traits\ResponseTrait;
use App\Domain\Url\Services\UrlServiceInterface;
use App\Presentation\Http\Controllers\Controller;
use App\Presentation\Http\Requests\StoreUrlRequest;
use App\Presentation\Http\Resources\UrlResource;
...
class UrlController extends Controller
{
     ...
     * )
     */
    public function save(StoreUrlRequest $request): JsonResponse
    {
        $urlData = $this->urlService->save(
            new SaveUrlDTO(
    ...
    public function show(Request $request, string $alias): JsonResponse
    {
        ...
        return $this->success(
            data: [
                'redirect_url' => $url->getOriginalUrl(),
            ],
        );
    }
}
